...
{
    // Scans the given assemblies for IRequestHandler<,> implementations and
    // registers each. Scoped is the safe default for a demo; nothing here
    // holds long-lived state that would care.
